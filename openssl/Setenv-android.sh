...
case $_ANDROID_ARCH in
	arch-arm)	  
	  ...
	  _ANDROID_CC="arm-linux-androideabi-gcc"
	  _ANDROID_RANLIB="arm-linux-androideabi-ranlib"
	  ;;
	arch-x86)	  
      ANDROID_TOOLS="i686-linux-android-gcc i686-linux-android-ranlib i686-linux-android-ld"
	  _ANDROID_CC="i686-linux-androideabi-gcc"
	  _ANDROID_RANLIB="i686-linux-androideabi-ranlib"
	  ;;
	arch-arm64)	  
      ANDROID_TOOLS="aarch64-linux-android-gcc aarch64-linux-android-ranlib aarch64-linux-android-ld"
	  _ANDROID_CC="aarch64-linux-androideabi-gcc"
	  _ANDROID_RANLIB="aarch64-linux-androideabi-ranlib"
	  ;;	  
	arch-x86_64)	  
      ANDROID_TOOLS="x86_64-linux-android-gcc x86_64-linux-android-ranlib x86_64-linux-android-ld"
	  _ANDROID_CC="x86_64-linux-androideabi-gcc"
	  _ANDROID_RANLIB="x86_64-linux-androideabi-ranlib"
	  ;;	  
	*)
...
export ANDROID_CC="${_ANDROID_CC}"	  
export ANDROID_RANLIB="${_ANDROID_RANLIB}"
export ANDROID_TOOLCHAIN="${ANDROID_TOOLCHAIN}"
